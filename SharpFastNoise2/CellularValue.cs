            ...
            for (int xi = 0; xi < 3; xi++)
            {
                ...
                for (int yi = 0; yi < 3; yi++)
                {
                    ...
                    for (int zi = 0; zi < 3; zi++)
                    {
                        ...
                        f32 xd = F.Sub(F.Converti32_f32(F.And(hash, F.Broad_i32(0x3ff))), F.Broad_f32(0x3ff / 2.0f));
                        f32 yd = F.Sub(F.Converti32_f32(F.And(F.RightShift(hash, 10), F.Broad_i32(0x3ff))), F.Broad_f32(0x3ff / 2.0f));
                        f32 zd = F.Sub(F.Converti32_f32(F.And(F.RightShift(hash, 20), F.Broad_i32(0x3ff))), F.Broad_f32(0x3ff / 2.0f));
