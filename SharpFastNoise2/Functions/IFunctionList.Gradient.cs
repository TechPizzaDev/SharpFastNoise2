...
namespace SharpFastNoise2.Functions
{
        ...
        where F : IFunctionList<m32, f32, i32, F>
    {
        ...
        static virtual f32 GetGradientDotFancy(i32 hash, f32 fX, f32 fY)
        {
            ...
            m32 xy = F.NotEqual(F.And(index, F.Broad_i32(1 << 2)), F.Broad_i32(0));
            ...
            m32 aMul2 = F.NotEqual(F.And(index, F.Broad_i32(1 << 1)), F.Broad_i32(0));

            a = F.Mul(a, F.Select_f32(aMul2, F.Broad_f32(2), F.Broad_f32(Gradient.ROOT3)));
        ...
        static virtual f32 GetGradientDot(i32 hash, f32 fX, f32 fY)
        {
            ...
            m32 mbit4 = F.NotEqual(F.And(hash, F.Broad_i32(1 << 2)), F.Broad_i32(0));
            ...
            return F.FMulAdd_f32(F.Broad_f32(1.0f + Gradient.ROOT2), a, b);
        }
        ...
        static virtual f32 GetGradientDot(i32 hash, f32 fX, f32 fY, f32 fZ, f32 fW)
        {
            ...
            f32 b = F.Select_f32(F.GreaterThan(p, F.Broad_i32(1 << 3)), fY, fZ);
